...
-- 1. アカウント
INSERT OR IGNORE INTO accounts (id, username, password_hash, email, role, created_at) VALUES
(1, 'admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'admin@example.com', 'admin', datetime('now'));
