...
VALUES (
  ...
  json('[{"name":"山田 太郎","age":39,"gender":"男性","email":"yamada.taro@example.com","phone":"090-1234-5678","birth":"1985-03-15"}]'),
...
VALUES (
  ...
  json('[{"name":"佐藤 花子","age":34,"gender":"女性","email":"sato.hanako@example.com","phone":"080-2345-6789","birth":"1990-07-20"},{"name":"佐藤 太一","age":8,"gender":"男性","email":"","phone":"","birth":"2016-04-10"}]'),
...
VALUES (
  ...
  json('[{"name":"佐藤 花子","age":34,"gender":"女性","email":"sato.hanako@example.com","phone":"080-2345-6789","birth":"1990-07-20"}]'),
...
VALUES (
  ...
  json('[{"name":"鈴木 一郎","age":36,"gender":"男性","email":"suzuki.ichiro@example.com","phone":"090-3456-7890","birth":"1988-11-10"}]'),
...
VALUES (
  ...
  json('[{"name":"高橋 美咲","age":32,"gender":"女性","email":"takahashi.misaki@example.com","phone":"080-4567-8901","birth":"1992-05-25"},{"name":"高橋 健","age":35,"gender":"男性","email":"","phone":"080-1111-2222","birth":"1989-08-15"},{"name":"高橋 結衣","age":7,"gender":"女性","email":"","phone":"","birth":"2017-03-20"},{"name":"高橋 蓮","age":5,"gender":"男性","email":"","phone":"","birth":"2019-06-10"}]'),
  'active', datetime('now', '-1 day')
);
...
VALUES (
  ...
  json('[{"name":"田中 健太","age":29,"gender":"男性","email":"tanaka.kenta@example.com","phone":"090-5678-9012","birth":"1995-09-08"},{"name":"山本 大輔","age":30,"gender":"男性","email":"yamamoto.daisuke@example.com","phone":"090-9999-1111","birth":"1994-02-20"},{"name":"中村 翔太","age":28,"gender":"男性","email":"nakamura.shota@example.com","phone":"090-8888-2222","birth":"1996-11-05"}]'),
...
VALUES (
  ...
  json('{"reason_category":"customer_request","detailed_reason":"中村翔太さんが都合により参加できなくなった","approved_by":"管理者B","approval_date":"' || datetime('now', '-1 day') || '","refund_participants":["中村 翔太"]}'),
  datetime('now', '-1 day')
);
